...
- Dynamic Programming:
    [Các dạng DP chính](<../Kiến thức đã học/Dynamic Programming/DP_pattern.md>), [DP how to solve it G.Polya](<../Kiến thức đã học/Dynamic Programming/DP how to solve it G.Polya.md>), [dp_bitmask](<../Kiến thức đã học/Dynamic Programming/dp_bitmask.md>), [dp_digit](<../Kiến thức đã học/Dynamic Programming/dp_digit.md>), [DP_optimization](<../Kiến thức đã học/Dynamic Programming/DP_optimization.md>), [Slope trick](<../Kiến thức đã học/Dynamic Programming/Slope trick.md>)
- Greedy:
